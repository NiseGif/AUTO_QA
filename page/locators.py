...
class RegisterPageLocators:
    INPUT_EMAIL = (By.ID, "id_login-username")
    INPUT_PASSWORD = (By.ID, "id_login-password")
    INPUT_REGISTER_EMAIL = (By.ID, "id_registration-email")
    INPUT_REGISTER_PASSWORD = (By.ID, "id_registration-password1")
    INPUT_REGISTER_PASSWORD_CONFIRM = (By.ID, "id_registration-password2")